...
<section class="page">
<!--ШАПКА-->
<div class="cover cover--way">
    <div class="cover__background">
        <img src="images/content/way_nocities_bg.jpg" alt="" class="cover__background_img"/>
    </div>
    <div class="cover__content page_width_1200">
        ...
        <h1 class="cover__title bebas">ВЫберите город и мы познакомим <br/>
            вас с лучшими экспертами!</h1>

        <nav class="cover__towns bebas">
            <a href="" class="cover__towns__item">барселона</a>
            <a href="" class="cover__towns__item">нью-йорк</a>
            <a href="" class="cover__towns__item">МИЛАН</a>
            <a href="" class="cover__towns__item">АМСТЕРДАМ</a>
            <a href="" class="cover__towns__item">ПРАГА</a>
        </nav>
    </div>
